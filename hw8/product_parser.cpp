...
{
  Product* libro = new Book("book",prodName_, price_, qty_,isbn_, author_);
  return libro;
}
...
{
  Product* ropa = new Clothing("clothing",prodName_, price_, qty_,size_,brand_);
  return ropa;
}
...
{
  Product* pelicula = new Movie("movie",prodName_, price_, qty_,genre_, rating_);
  return pelicula;
