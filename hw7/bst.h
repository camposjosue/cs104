 ...
 public:
  ...
  public:
    ...
    bool operator==(const iterator& rhs) const
      { return curr->getItem() == rhs.curr->getItem();}
    ...
    Node<KeyType, ValueType>* next()
      {
      	...
      	if(curr->getRight() != NULL){
     		 ...
     		 while (curr->getLeft() != NULL) {
       		...
       		temp = curr->getParent();//p = nodePtr->parent;
       		while (temp != NULL && curr == temp->getRight())// p != NULL && nodePtr == p->right)
       		{
           		curr = temp;
           		temp = temp->getParent(); //p = p->parent;
         	}
